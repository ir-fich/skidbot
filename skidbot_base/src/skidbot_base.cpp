#include <chrono>
// #include <functional>
#include <thread> // esto lo saque de otro lado
#include <controller_manager/controller_manager.h> // esto lo saque de otro lado
#include <ros/callback_queue.h>
#include <skidbot_hw_interface.h>
...
{
    ros::init(argc, argv, "skidbot_base_node");

    MyRobotHWInterface hw;
    controller_manager::ControllerManager cm(&hw, hw.nh);

    double control_frequency;
    hw.private_nh.param<double>("control_frequency", control_frequency, 20.0);
